...
import { sendValidationError, sendInvalidIataError, sendInvalidDateError, sendDateRangeError, sendMissingParametersError } from '../utils/responseHelpers.js';
...
export const validateRequiredParams = (paramNames: string[], source: 'query' | 'params' = 'query') => {
  return (req: Request, res: Response, next: NextFunction) => {
